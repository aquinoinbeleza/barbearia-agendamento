...
function logErro_(ctx, err){ try { var sh = sheet_(SHEETS.LOG); sh.appendRow([now_(),'ERRO',ctx,String(err&&err.message?err.message:err)]); if (sh.getLastRow() > 5000) sh.deleteRows(2, 2000); } catch(e){} } // auto-cap: Log nunca incha a planilha
